...
public class MaterialMap1_8 extends MaterialMap {

    public MaterialMap1_8() {
        // 1.20 -> 1.19
        ...
        set("BAMBOO_CHEST_RAFT", new MetaMaterial(m("BOAT"), false));
        ...
        set("BAMBOO_RAFT", new MetaMaterial(m("BOAT"), false));
        ...
        set("CHERRY_BOAT", new MetaMaterial(m("BOAT"), false));
        set("CHERRY_BUTTON", new MetaMaterial(m("WOOD_BUTTON"), false));
        set("CHERRY_CHEST_BOAT", new MetaMaterial(m("BOAT"), false));
        ...
        // 1.19 -> 1.18
        set("ACACIA_CHEST_BOAT", new MetaMaterial(m("BOAT"), false));
        set("ALLAY_SPAWN_EGG", new MetaMaterial(m("MONSTER_EGG"), false, Applicators.blockAir(), Applicators.itemData(m("MONSTER_EGG"), 65)));
        set("BIRCH_CHEST_BOAT", new MetaMaterial(m("BOAT"), false));
        set("DARK_OAK_CHEST_BOAT", new MetaMaterial(m("BOAT"), false));
        ...
        set("JUNGLE_CHEST_BOAT", new MetaMaterial(m("BOAT"), false));
        set("MANGROVE_BOAT", new MetaMaterial(m("BOAT"), false));
        set("MANGROVE_BUTTON", new MetaMaterial(m("WOOD_BUTTON"), false));
        set("MANGROVE_CHEST_BOAT", new MetaMaterial(m("BOAT"), false));
        ...
        set("SPRUCE_CHEST_BOAT", new MetaMaterial(m("BOAT"), false));
        ...
        set("DIRT_PATH", new MetaMaterial(m("SOIL"), false));
        ...
        set("LIGHTNING_ROD", new MetaMaterial(m("BLAZE_ROD"), false, Applicators.blockBasic(m("THIN_GLASS")), Applicators.itemBasic(m("BLAZE_ROD"))));
        ...
        set("QUARTZ_BRICKS", new MetaMaterial(m("BRICK"), false));
        ...
        set("HONEY_BOTTLE", new MetaMaterial(m("POTION"), false));
        ...
        // 1.13 -> 1.12
        set("ACACIA_BOAT", new MetaMaterial(m("BOAT"), false));
        ...
        set("BEETROOTS", new MetaMaterial(m("CARROT"), false, Applicators.blockBasic(m("CARROT")), Applicators.itemBasic(m("CARROT_ITEM"))));
        set("BIRCH_BOAT", new MetaMaterial(m("BOAT"), false));
        ...
        set("CHAIN_COMMAND_BLOCK", new MetaMaterial(m("COMMAND"), false));
        ...
        set("DARK_OAK_BOAT", new MetaMaterial(m("BOAT"), false));
        ...
        set("DARK_PRISMARINE_SLAB", new MetaMaterial(m("STEP"), false));
        set("DARK_PRISMARINE_STAIRS", new MetaMaterial(m("SMOOTH_STAIRS"), false));
        ...
        set("DRAGON_BREATH", new MetaMaterial(m("GLASS_BOTTLE"), false));
        ...
        set("END_STONE_BRICKS", new MetaMaterial(m("SMOOTH_BRICK"), false));
        ...
        set("JUNGLE_BOAT", new MetaMaterial(m("BOAT"), false));
        ...
        set("LIGHT_GRAY_SHULKER_BOX", new MetaMaterial(m("CHEST"), false));
        ...
        set("MAGMA_BLOCK", new MetaMaterial(m("STATIONARY_LAVA"), false, Applicators.blockBasic(m("STATIONARY_LAVA")), Applicators.itemBasic(m("LAVA_BUCKET"))));
        ...
        set("POPPED_CHORUS_FRUIT", new MetaMaterial(m("POTATO_ITEM"), false));
        ...
        set("PRISMARINE_BRICK_SLAB", new MetaMaterial(m("STEP"), false));
        set("PRISMARINE_BRICK_STAIRS", new MetaMaterial(m("SMOOTH_STAIRS"), false));
        set("PRISMARINE_BRICKS", new MetaMaterial(m("PRISMARINE"), true, 1));
        set("PRISMARINE_SLAB", new MetaMaterial(m("STEP"), false));
        set("PRISMARINE_STAIRS", new MetaMaterial(m("SMOOTH_STAIRS"), false));
        ...
        set("RED_NETHER_BRICKS", new MetaMaterial(m("NETHER_BRICK"), false));
        ...
        set("REPEATING_COMMAND_BLOCK", new MetaMaterial(m("COMMAND"), false));
        ...
        set("SHULKER_BOX", new MetaMaterial(m("CHEST"), false));
        ...
        set("SPRUCE_BOAT", new MetaMaterial(m("BOAT"), false));
        ...
        set("TOTEM_OF_UNDYING", new MetaMaterial(m("GOLDEN_APPLE"), false));
        ...
        // CONCRETE and CONCRETE_POWDER are removed here, but not handled because they do not exist in 1.13+ (replaced by *_CONCRETE and *_CONCRETE_POWDER)
        ...
        // SILVER_GLAZED_TERRACOTTA is removed here, but not handled because it does not exist in 1,13+ (replaced by LIGHT_GRAY_GLAZED_TERRACOTTA)
        ...
        // 1.11 -> 1.10
        // *_SHULKER_BOX is removed here, but not handled because it does not exist in 1.13+ (replaced by SHULKER_BOX)
        set("OBSERVER", new MetaMaterial(m("REDSTONE_COMPARATOR"), false));
        // TOTEM is removed here, but not handled because it does not exist in 1.13+ (replaced by TOTEM_OF_UNDYING)

        // 1.10 -> 1.9
        set("BONE_BLOCK", new MetaMaterial(m("STAINED_CLAY"), false));
        // MAGMA is removed here, but not handled because it does not exist in 1.13+ (replaced by MAGMA_BLOCK)
        set("NETHER_WART_BLOCK", new MetaMaterial(m("REDSTONE_BLOCK"), false));
        // RED_NETHER_BRICK is removed here, but not handled because it does not exist in 1.13+ (replaced by RED_NETHER_BRICKS)
        set("STRUCTURE_VOID", new MetaMaterial(m("BARRIER"), false));

        // 1.9 -> 1.8
        set("BEETROOT", new MetaMaterial(m("CARROT_ITEM"), false, Applicators.blockBasic(m("CARROT")), Applicators.itemBasic(m("CARROT_ITEM"))));
        // BEETROOT_BLOCK is removed here, but not handled because it does not exist in 1.13+ (replaced by BEETROOTS)
        set("BEETROOT_SEEDS", new MetaMaterial(m("SEEDS"), false));
        set("BEETROOT_SOUP", new MetaMaterial(m("MUSHROOM_SOUP"), false));
        // BOAT_* is removed here, but not handled because it does not exist in 1.13+ (replaced by *_BOAT)
        set("CHROUS_FLOWER", new MetaMaterial(m("HUGE_MUSHROOM_2"), false));
        set("CHORUS_FRUIT", new MetaMaterial(m("APPLE"), false));
        // CHORUS_FRUIT_POPPED is removed here, but not handled because it does not exist in 1.13+ (replacaed by POPPED_CHORUS_FRUIT)
        set("CHORUS_PLANT", new MetaMaterial(m("LEAVES"), false));
        // COMMAND_* is removed here, but not handled because it does not exist in 1.13+ (replaced by *_COMMAND_BLOCK)
        set("ELYTRA", new MetaMaterial(m("FEATHER"), false));
        // END_BRICKS is removed here, but not handled because it does not exist in 1.13+ (replaced by END_STONE_BRICKS)
        set("END_CRYSTAL", new MetaMaterial(m("TNT"), false));
        set("END_GATEWAY", new MetaMaterial(m("ENDER_PORTAL"), false, Applicators.blockBasic(m("ENDER_PORTAL")), Applicators.itemBasic(m("ENDER_PORTAL_FRAME"))));
        set("END_ROD", new MetaMaterial(m("BLAZE_ROD"), false, Applicators.blockBasic(m("THIN_GLASS")), Applicators.itemBasic(m("BLAZE_ROD"))));
        set("FROSTED_ICE", new MetaMaterial(m("ICE"), false));
        // GRASS_PATH is removed here, but not handled because it does not exist in 1.13+ (replaced by DIRT_PATH)
        set("LINGERING_POTION", new MetaMaterial(m("POTION"), false));
        set("PURPUR_BLOCK", new MetaMaterial(m("QUARTZ_BLOCK"), false));
        set("PURPUR_DOUBLE_SLAB", new MetaMaterial(m("DOUBLE_STEP"), false, 7));
        set("PURPUR_PILLAR", new MetaMaterial(m("QUARTZ_BLOCK"), false, 2));
        set("PURPUR_SLAB", new MetaMaterial(m("STEP"), false, 7));
        set("PURPUR_STAIRS", new MetaMaterial(m("QUARTZ_STAIRS"), false));
        set("SHIELD", new MetaMaterial(m("LEATHER_CHESTPLATE"), false));
        set("SPECTRAL_ARROW", new MetaMaterial(m("ARROW"), false));
        set("SPLASH_POTION", new MetaMaterial(m("POTION"), false));
        set("STRUCTURE_BLOCK", new MetaMaterial(m("WOOL"), false, 15));
        set("TIPPED_ARROW", new MetaMaterial(m("ARROW"), false));
    }
