...
import static codes.wasabi.matlib.struct.applicator.Applicators.*;
...
public class MaterialMap1_8 extends MaterialMap {
    ...
    public MaterialMap1_8() {
        ...
        set("ALLAY_SPAWN_EGG", new MetaMaterial(m("MONSTER_EGG"), false, blockAir(), itemData(m("MONSTER_EGG"), 65)));
        ...
        set("FROG_SPAWN_EGG", new MetaMaterial(m("MONSTER_EGG"), false, blockAir(), itemData(m("MONSTER_EGG"), 93)));
        ...
        set("MANGROVE_SIGN", new MetaMaterial(m("SIGN"), false, blockBasic(m("SIGN_POST")), itemBasic(m("SIGN"))));
        ...
        set("POTTED_MANGROVE_PROPAGULE", new MetaMaterial(m("FLOWER_POT"), false, blockData(m("FLOWER_POT"), 6), itemData(m("FLOWER_POT_ITEM"), 6)));
        ...
        set("WARDEN_SPAWN_EGG", new MetaMaterial(m("MONSTER_EGG"), false, blockAir(), itemData(m("MONSTER_EGG"), 58)));
        ...
        set("LIGHTNING_ROD", new MetaMaterial(m("BLAZE_ROD"), false, blockBasic(m("THIN_GLASS")), itemBasic(m("BLAZE_ROD"))));
        ...
        set("POTTED_AZALEA_BUSH", new MetaMaterial(m("FLOWER_POT"), false, blockData(m("FLOWER_POT"), 6), itemData(m("FLOWER_POT_ITEM"), 6)));
        set("POTTED_FLOWERING_AZALEA_BUSH", new MetaMaterial(m("FLOWER_POT"), false, blockData(m("FLOWER_POT"), 6), itemData(m("FLOWER_POT_ITEM"), 6)));
        ...
        set("CRIMSON_SIGN", new MetaMaterial(m("SIGN"), false, blockBasic(m("SIGN_POST")), itemBasic(m("SIGN"))));
        ...
        set("POTTED_CRIMSON_FUNGUS", new MetaMaterial(m("FLOWER_POT"), false, blockData(m("FLOWER_POT"), 7), itemData(m("FLOWER_POT_ITEM"), 7)));
        set("POTTED_CRIMSON_ROOTS", new MetaMaterial(m("FLOWER_POT"), false, blockData(m("FLOWER_POT"), 7), itemData(m("FLOWER_POT_ITEM"), 7)));
        set("WARPED_CRIMSON_FUNGUS", new MetaMaterial(m("FLOWER_POT"), false, blockData(m("FLOWER_POT"), 7), itemData(m("FLOWER_POT_ITEM"), 7)));
        set("WARPED_CRIMSON_ROOTS", new MetaMaterial(m("FLOWER_POT"), false, blockData(m("FLOWER_POT"), 7), itemData(m("FLOWER_POT_ITEM"), 7)));
        ...
        set("WARPED_SIGN", new MetaMaterial(m("SIGN"), false, blockBasic(m("SIGN_POST")), itemBasic(m("SIGN"))));
        ...
        // 1.14 -> 1.13
        set("ACACIA_SIGN", new MetaMaterial(m("SIGN"), false, blockBasic(m("SIGN_POST")), itemBasic(m("SIGN"))));
        ...
        set("BIRCH_SIGN", new MetaMaterial(m("SIGN"), false, blockBasic(m("SIGN_POST")), itemBasic(m("SIGN"))));
        ...
        set("DARK_OAK_SIGN", new MetaMaterial(m("SIGN"), false, blockBasic(m("SIGN_POST")), itemBasic(m("SIGN"))));
        set("DARK_OAK_WALL_SIGN", new MetaMaterial(m("SIGN"), false, blockBasic(m("SIGN_POST")), itemBasic(m("SIGN"))));
        ...
        set("JUNGLE_SIGN", new MetaMaterial(m("SIGN"), false, blockBasic(m("SIGN_POST")), itemBasic(m("SIGN"))));
        ...
        set("OAK_SIGN", new MetaMaterial(m("SIGN"), true, blockBasic(m("SIGN_POST")), itemBasic(m("SIGN"))));
        ...
        set("POTTED_BAMBOO", new MetaMaterial(m("FLOWER_POT"), false, blockData(m("FLOWER_POT"), 5), itemData(m("FLOWER_POT_ITEM"), 5)));
        set("POTTED_CORNFLOWER", new MetaMaterial(m("FLOWER_POT"), false, blockData(m("FLOWER_POT"), 2), itemData(m("FLOWER_POT_ITEM"), 2)));
        set("POTTED_LILY_OF_THE_VALLEY", new MetaMaterial(m("FLOWER_POT"), false, blockData(m("FLOWER_POT"), 2), itemData(m("FLOWER_POT_ITEM"), 2)));
        set("POTTED_WITHER_ROSE", new MetaMaterial(m("FLOWER_POT"), false, blockData(m("FLOWER_POT"), 1), itemData(m("FLOWER_POT_ITEM"), 1)));
        ...
        set("SPRUCE_SIGN", new MetaMaterial(m("SIGN"), false, blockBasic(m("SIGN_POST")), itemBasic(m("SIGN"))));
        ...
        set("ACACIA_DOOR", new MetaMaterial(m("ACACIA_DOOR"), true, blockBasic(m("ACACIA_DOOR")), itemBasic(m("ACACIA_DOOR_ITEM"))));
        ...
        set("BEETROOTS", new MetaMaterial(m("CARROT"), false, blockBasic(m("CARROT")), itemBasic(m("CARROT_ITEM"))));
        set("BIRCH_BOAT", new MetaMaterial(m("BOAT"), false));
        set("BIRCH_BUTTON", new MetaMaterial(m("WOOD_BUTTON"), false));
        set("BIRCH_DOOR", new MetaMaterial(m("BIRCH_DOOR"), true, blockBasic(m("BIRCH_DOOR")), itemBasic(m("BIRCH_DOOR_ITEM"))));
        ...
        set("BLACK_BANNER", new MetaMaterial(m("BANNER"), true, blockBasic(m("STANDING_BANNER")), itemBasic(m("BANNER"))));
        set("BLACK_BED", new MetaMaterial(m("BED"), true, blockData(m("BED_BLOCK"), 15), itemData(m("BED"), 15)));
        ...
        set("BLUE_BANNER", new MetaMaterial(m("BANNER"), true, blockData(m("STANDING_BANNER"), 4), itemData(m("BANNER"), 4)));
        set("BLUE_BED", new MetaMaterial(m("BED"), true, blockData(m("BED_BLOCK"), 11), itemData(m("BED"), 11)));
        ...
        set("BROWN_BANNER", new MetaMaterial(m("BANNER"), true, blockData(m("STANDING_BANNER"), 3), itemData(m("BANNER"), 3)));
        set("BROWN_BED", new MetaMaterial(m("BED"), true, blockData(m("BED_BLOCK"), 12), itemData(m("BED"), 12)));
        ...
        set("CARROTS", new MetaMaterial(m("CARROT"), true, blockBasic(m("CARROT")), itemBasic(m("CARROT_ITEM"))));
        ...
        set("COCOA_BEANS", new MetaMaterial(m("INK_SACK"), true, blockBasic(m("COCOA")), itemData(m("INK_SACK"), 3)));
        ...
        set("COMPARATOR", new MetaMaterial(m("REDSTONE_COMPARATOR"), true, blockBasic(m("REDSTONE_COMPARATOR_OFF")), itemBasic(m("REDSTONE_COMPARATOR"))));
        ...
        set("CREEPER_HEAD", new MetaMaterial(m("SKULL"), true, blockData(m("SKULL"), 4), itemData(m("SKULL_ITEM"), 4)));
        ...
        set("CYAN_BANNER", new MetaMaterial(m("BANNER"), true, blockData(m("STANDING_BANNER"), 6), itemData(m("BANNER"), 6)));
        set("CYAN_BED", new MetaMaterial(m("BED"), true, blockData(m("BED_BLOCK"), 9), itemData(m("BED"), 9)));
        ...
        set("DARK_OAK_DOOR", new MetaMaterial(m("DARK_OAK_DOOR"), true, blockBasic(m("DARK_OAK_DOOR")), itemBasic(m("DARK_OAK_DOOR_ITEM"))));
        ...
        set("DRAGON_HEAD", new MetaMaterial(m("SKULL"), true, blockData(m("SKULL"), 5), itemData(m("SKULL_ITEM"), 5)));
        ...
        set("GRAY_BANNER", new MetaMaterial(m("BANNER"), true, blockData(m("STANDING_BANNER"), 8), itemData(m("BANNER"), 8)));
        set("GRAY_BED", new MetaMaterial(m("BED"), true, blockData(m("BED_BLOCK"), 7), itemData(m("BED"), 7)));
        ...
        set("GREEN_BANNER", new MetaMaterial(m("BANNER"), true, blockData(m("STANDING_BANNER"), 2), itemData(m("BANNER"), 2)));
        set("GREEN_BED", new MetaMaterial(m("BED"), true, blockData(m("BED_BLOCK"), 13), itemData(m("BED"), 13)));
        ...
        set("JUNGLE_DOOR", new MetaMaterial(m("JUNGLE_DOOR"), true, blockBasic(m("JUNGLE_DOOR")), itemBasic(m("JUNGLE_DOOR_ITEM"))));
        ...
        set("LIGHT_BLUE_BANNER", new MetaMaterial(m("BANNER"), true, blockData(m("STANDING_BANNER"), 12), itemData(m("BANNER"), 12)));
        set("LIGHT_BLUE_BED", new MetaMaterial(m("BED"), true, blockData(m("BED_BLOCK"), 3), itemData(m("BED"), 3)));
        ...
        set("LIGHT_GRAY_BANNER", new MetaMaterial(m("BANNER"), true, blockData(m("STANDING_BANNER"), 7), itemData(m("BANNER"), 7)));
        set("LIGHT_GRAY_BED", new MetaMaterial(m("BED"), true, blockData(m("BED_BLOCK"), 8), itemData(m("BED"), 8)));
        ...
        set("LIME_BANNER", new MetaMaterial(m("BANNER"), true, blockData(m("STANDING_BANNER"), 10), itemData(m("BANNER"), 10)));
        set("LIME_BED", new MetaMaterial(m("BED"), true, blockData(m("BED_BLOCK"), 5), itemData(m("BED"), 5)));
        ...
        set("MAGENTA_BANNER", new MetaMaterial(m("BANNER"), true, blockData(m("STANDING_BANNER"), 13), itemData(m("BANNER"), 13)));
        set("MAGENTA_BED", new MetaMaterial(m("BED"), true, blockData(m("BED_BLOCK"), 2), itemData(m("BED"), 2)));
        ...
        set("MAGMA_BLOCK", new MetaMaterial(m("STATIONARY_LAVA"), false, blockBasic(m("STATIONARY_LAVA")), itemBasic(m("LAVA_BUCKET"))));
        ...
        set("OAK_DOOR", new MetaMaterial(m("WOOD_DOOR"), true, blockBasic(m("WOODEN_DOOR")), itemBasic(m("WOOD_DOOR"))));
        ...
        set("ORANGE_BANNER", new MetaMaterial(m("BANNER"), true, blockData(m("STANDING_BANNER"), 14), itemData(m("BANNER"), 14)));
        set("ORANGE_BED", new MetaMaterial(m("BED"), true, blockData(m("BED_BLOCK"), 1), itemData(m("BED"), 1)));
        ...
        set("PINK_BANNER", new MetaMaterial(m("BANNER"), true, blockData(m("STANDING_BANNER"), 9), itemData(m("BANNER"), 9)));
        set("PINK_BED", new MetaMaterial(m("BED"), true, blockData(m("BED_BLOCK"), 6), itemData(m("BED"), 6)));
        ...
        set("PLAYER_HEAD", new MetaMaterial(m("SKULL"), true, blockData(m("SKULL"), 3), itemData(m("SKULL_ITEM"), 3)));
        ...
        set("POTATOES", new MetaMaterial(m("POTATO"), true, blockBasic(m("POTATO")), itemBasic(m("POTATO_ITEM"))));
        set("POTTED_ACACIA_SAPLING", new MetaMaterial(m("FLOWER_POT"), false, blockData(m("FLOWER_POT"), 6), itemData(m("FLOWER_POT_ITEM"), 6)));
        set("POTTED_ALLIUM", new MetaMaterial(m("FLOWER_POT"), false, blockData(m("FLOWER_POT"), 1), itemData(m("FLOWER_POT_ITEM"), 1)));
        set("POTTED_AZURE_BLUET", new MetaMaterial(m("FLOWER_POT"), false, blockData(m("FLOWER_POT"), 2), itemData(m("FLOWER_POT_ITEM"), 2)));
        set("POTTED_BIRCH_SAPLING", new MetaMaterial(m("FLOWER_POT"), true, blockData(m("FLOWER_POT"), 5), itemData(m("FLOWER_POT_ITEM"), 5)));
        set("POTTED_BLUE_ORCHID", new MetaMaterial(m("FLOWER_POT"), false, blockData(m("FLOWER_POT"), 1), itemData(m("FLOWER_POT_ITEM"), 1)));
        set("POTTED_BROWN_MUSHROOM", new MetaMaterial(m("FLOWER_POT"), true, blockData(m("FLOWER_POT"), 8), itemData(m("FLOWER_POT_ITEM"), 8)));
        set("POTTED_CACTUS", new MetaMaterial(m("FLOWER_POT"), true, blockData(m("FLOWER_POT"), 9), itemData(m("FLOWER_POT_ITEM"), 9)));
        set("POTTED_DANDELION", new MetaMaterial(m("FLOWER_POT"), true, blockData(m("FLOWER_POT"), 2), itemData(m("FLOWER_POT_ITEM"), 2)));
        set("POTTED_DARK_OAK_SAPLING", new MetaMaterial(m("FLOWER_POT"), false, blockData(m("FLOWER_POT"), 4), itemData(m("FLOWER_POT_ITEM"), 4)));
        set("POTTED_DEAD_BUSH", new MetaMaterial(m("FLOWER_POT"), true, blockData(m("FLOWER_POT"), 10), itemData(m("FLOWER_POT_ITEM"), 10)));
        set("POTTED_FERN", new MetaMaterial(m("FLOWER_POT"), true, blockData(m("FLOWER_POT"), 11), itemData(m("FLOWER_POT_ITEM"), 11)));
        set("POTTED_JUNGLE_SAPLING", new MetaMaterial(m("FLOWER_POT"), true, blockData(m("FLOWER_POT"), 6), itemData(m("FLOWER_POT_ITEM"), 6)));
        set("POTTED_OAK_SAPLING", new MetaMaterial(m("FLOWER_POT"), true, blockData(m("FLOWER_POT"), 3), itemData(m("FLOWER_POT_ITEM"), 3)));
        set("POTTED_ORANGE_TULIP", new MetaMaterial(m("FLOWER_POT"), false, blockData(m("FLOWER_POT"), 2), itemData(m("FLOWER_POT_ITEM"), 2)));
        set("POTTED_OXEYE_DAISY", new MetaMaterial(m("FLOWER_POT"), false, blockData(m("FLOWER_POT"), 2), itemData(m("FLOWER_POT_ITEM"), 2)));
        set("POTTED_PINK_TULIP", new MetaMaterial(m("FLOWER_POT"), false, blockData(m("FLOWER_POT"), 1), itemData(m("FLOWER_POT_ITEM"), 1)));
        set("POTTED_POPPY", new MetaMaterial(m("FLOWER_POT"), true, blockData(m("FLOWER_POT"), 1), itemData(m("FLOWER_POT_ITEM"), 1)));
        set("POTTED_RED_MUSHROOM", new MetaMaterial(m("FLOWER_POT"), true, blockData(m("FLOWER_POT"), 7), itemData(m("FLOWER_POT_ITEM"), 7)));
        set("POTTED_RED_TULIP", new MetaMaterial(m("FLOWER_POT"), false, blockData(m("FLOWER_POT"), 1), itemData(m("FLOWER_POT_ITEM"), 1)));
        set("POTTED_SPRUCE_SAPLING", new MetaMaterial(m("FLOWER_POT"), true, blockData(m("FLOWER_POT"), 4), itemData(m("FLOWER_POT_ITEM"), 4)));
        set("POTTED_WHITE_TULIP", new MetaMaterial(m("FLOWER_POT"), false, blockData(m("FLOWER_POT"), 2), itemData(m("FLOWER_POT_ITEM"), 2)));
        ...
        set("PURPLE_BANNER", new MetaMaterial(m("BANNER"), true, blockData(m("STANDING_BANNER"), 5), itemData(m("BANNER"), 5)));
        set("PURPLE_BED", new MetaMaterial(m("BED"), true, blockData(m("BED_BLOCK"), 10), itemData(m("BED"), 10)));
        ...
        set("RED_BANNER", new MetaMaterial(m("BANNER"), true, blockData(m("STANDING_BANNER"), 1), itemData(m("BANNER"), 1)));
        set("RED_BED", new MetaMaterial(m("BED"), true, blockData(m("BED_BLOCK"), 14), itemData(m("BED"), 14)));
        ...
        set("REPEATER", new MetaMaterial(m("DIODE"), true, blockBasic(m("DIODE_BLOCK_OFF")), itemBasic(m("DIODE"))));
        ...
        set("SKELETON_SKULL", new MetaMaterial(m("SKULL"), true, blockBasic(m("SKULL")), itemBasic(m("SKULL_ITEM"))));
        ...
        set("SPRUCE_DOOR", new MetaMaterial(m("SPRUCE_DOOR"), true, blockBasic(m("SPRUCE_DOOR")), itemBasic(m("SPRUCE_DOOR_ITEM"))));
        ...
        set("TRIDENT", new MetaMaterial(m("DIAMOND_SWORD"), false, blockAir(), itemMeta(m("DIAMOND_SWORD"), (ItemMeta im) -> im.addEnchant(Enchantment.DAMAGE_ALL, 1, false))));
        ...
        set("WHITE_BANNER", new MetaMaterial(m("BANNER"), true, blockData(m("STANDING_BANNER"), 15), itemData(m("BANNER"), 15)));
        set("WHITE_BED", new MetaMaterial(m("BED"), true, blockBasic(m("BED_BLOCK")), itemBasic(m("BED"))));
        ...
        set("WITHER_SKELETON_SKULL", new MetaMaterial(m("SKULL"), true, blockData(m("SKULL"), 1), itemData(m("SKULL_ITEM"), 1)));
        ...
        set("YELLOW_BANNER", new MetaMaterial(m("BANNER"), true, blockData(m("STANDING_BANNER"), 11), itemData(m("BANNER"), 11)));
        set("YELLOW_BED", new MetaMaterial(m("BED"), true, blockData(m("BED_BLOCK"), 4), itemData(m("BED"), 4)));
        ...
        set("ZOMBIE_HEAD", new MetaMaterial(m("SKULL"), true, blockData(m("SKULL"), 2), itemData(m("SKULL_ITEM"), 2)));
        ...
        // 1.9 -> 1.8
        set("BEETROOT", new MetaMaterial(m("CARROT_ITEM"), false, blockBasic(m("CARROT")), itemBasic(m("CARROT_ITEM"))));
        ...
        set("END_GATEWAY", new MetaMaterial(m("ENDER_PORTAL"), false, blockBasic(m("ENDER_PORTAL")), itemBasic(m("ENDER_PORTAL_FRAME"))));
        set("END_ROD", new MetaMaterial(m("BLAZE_ROD"), false, blockBasic(m("THIN_GLASS")), itemBasic(m("BLAZE_ROD"))));
